...
const defaultSchemaIfValueIsString = key => ({ [componentTag]:'input', placeholder: key })
const defaultSchemaIfValueIsNumber = key => ({ [componentTag]:'number', placeholder: key })
const defaultSchemaIfValueIsBoolean = key => ({ [componentTag]:'checkbox', placeholder: key })
// const defaultSchemaIfValueIsBoolean = key => ({ [componentTag]:'switch', activeText: key })
